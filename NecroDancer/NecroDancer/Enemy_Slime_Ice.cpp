...
Enemy_Slime_Ice::Enemy_Slime_Ice()
{
}
...
HRESULT Enemy_Slime_Ice::Init()
{
	...
	_image = IMAGEMANAGER->FindImage("SlimeIce");
...
void Enemy_Slime_Ice::Render()
{
	_image->AniRender(_posX, _posY, _ani);
	Enemy::UIRender();
}

void Enemy_Slime_Ice::Revision()
{
	_posX = _x * TILESIZEX;
	_posY = _y * TILESIZEY - 6;
}

void Enemy_Slime_Ice::Move()
{
	_atkCheck = FALSE;
